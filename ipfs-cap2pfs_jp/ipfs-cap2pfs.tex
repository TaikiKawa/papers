...
\title{IPFS - Content Addressed, Versioned, P2P File System (DRAFT 3 Japanese version)}
\subtitle{}
...
% serverのlocationはアクセスするとき正当性があり知っている　さらにpubkeyはそこからもらえる。その二つを通して正当なnode idにアクセスできる。逆に自分のいるlocatinに足して
%ユーザーが探しているnode idとなるpub key生成が難しい。
